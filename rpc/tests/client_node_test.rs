...
fn test_set_log_level() {
    ...
    let result = client.set_log_level("WARNING");
...
fn test_get_memory_info() {
    ...
    let memoryinfo = client.get_memory_info();
...
fn test_validate_address_ok() {
    ...
    let validateaddress = client.validate_address("ts1qq79hzunlkj50fvm7rxg3xetx4kml4e0am43htk");
...
fn test_validate_address_fail() {
    ...
    let validateaddress = client.validate_address("notanaddress");
...
fn test_create_multisig() {
    ...
    let multisig = client.create_multisig(&1, &vec![pub1, pub2, pub3]);
...
#[test]
fn test_sign_message_with_priv_key_fail() {
    let client = common::setup();
    ...
    let signedmessage = client.sign_message_with_priv_key(privkey, message);
...
fn test_verify_message_fail() {
    ...
    let verified = client.verify_message(address, signature, message);
